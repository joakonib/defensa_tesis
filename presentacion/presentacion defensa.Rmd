...
.panelset[
.panel[.panel-name[Info Disponible en Paradatos]
...
table_suso <- data.frame(
  ...
  Ejemplo = c(
    "75efdc0456fb4b35be4690bd19eab870",
    "1",
    "AnswerSet",
    "Enumerator25",
    "1",
...
.panel[.panel-name[Ejemplo de una base de paradatos]

```{r parad, echo=FALSE, include = T, out.width="80%"}

test_data <- readRDS("input/paradatos filtrados.RDS")
