...
### ¿Y por qué esto es importante esta decisión?
...
Los paradatos corresponden a la información recolectada durante el proceso de aplicación de un instrumento (Callegaro, 2013). Entre algunos de los elementos a identificar está el orden en qué se responde una pregunta, la fecha y hora de la respuesta o también, el momento en que se inicia o sincronizan las respuestas para enviar la información hacia los servidores donde se alojan las respuestas (Olson & Parkhurst, 2013).
...
- Es exploratorio a nivel institucional ya que aún no existen directrices o documentaciones que den cuenta de la utilización de paradatos. 

- También puede considerarse descriptivo puesto que parte por esquemas y formas de trabajo preestablecidas, en donde el diagnóstico es más fácil de constreñir. En este sentido es posible apoyarse sobre la bibliografía respecto a la reducción de los errores no muestrales y/o errores de medición.
