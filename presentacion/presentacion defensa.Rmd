...
kable(table_opera, format = "html", col.names = c("Dimensión", "Subdimensión", "Definición/objetivo conceptual")) %>%
    kable_styling(full_width = TRUE, bootstrap_options = c("striped", "hover", "condensed", "responsive"), font_size = 15)%>%
